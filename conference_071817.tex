...
In the design phase, we create the reference architecture by analysing existing architectures, described in section \todo{ref}.
...
In the details phase, interfaces and concepts are described in detail to create a low-level implementation architecture.
